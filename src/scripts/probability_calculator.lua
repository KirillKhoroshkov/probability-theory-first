...
function probability_calculator.calculate_a_priori_with_frequency_of_letters(alphabet, frequency_of_letters)
    ...
    -- и в сумме эти вероятности равны единице. Какова вероятность появления других символов
    -- относительно этих - не известно. Поэтому как-то так. Тем символам, вероятность которых
    -- неизвестна, присваивается вероятность 1/N. Затем каждая вероятность делится на сумму
    -- всех вероятностей, чтобы в сумме получилось 1]]
    local a_priori = {}
    local size = 0
    for _, _ in pairs(alphabet.codes) do size = size + 1 end
    local probability_of_symbol = 1 / size
